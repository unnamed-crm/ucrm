...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly modelValue: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<import("./collapse").CollapseModelValue>, () => [], unknown, unknown, unknown>;
}, {
    ...
    modelValue: import("element-plus/es/utils").BuildPropType<import("element-plus/es/utils").PropWrapper<import("./collapse").CollapseModelValue>, unknown, unknown>;
    accordion: boolean;
}>;
