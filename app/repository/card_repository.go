...
type CardRepository interface {
	AddCard(ctx context.Context, name string, pipelineId string) (*models.Card, error)
	...
	UpdateOrderForCards(ctx context.Context, cards map[string]int) error
	GetCardsByCardPipelineId(ctx context.Context, cardId string) ([]models.Card, error)
}
