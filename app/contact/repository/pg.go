...
func (r *Repository) GetOneContact(ctx context.Context, contactId string) (*models.Contact, error) {
...
func (r *Repository) AddContact(ctx context.Context, dashboardId string, cardId *string, name string, phone string, city string) (*models.Contact, error) {
	contact := &models.Contact{}
...
func (r *Repository) UpdateContact(ctx context.Context, contactId string, name *string, phone *string, city *string, contactFields *map[string]string) error {
...
func (r *Repository) RenameContact(ctx context.Context, contactId string, newName string) error {
