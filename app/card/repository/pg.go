...
func (r *Repository) AddCard(ctx context.Context, name string, order int, pipelineId string) (*models.Card, error) {
	card := &models.Card{}
...
func (r *Repository) CheckCardExists(ctx context.Context, cardId string) (bool, error) {
...
func (r *Repository) UpdateCard(ctx context.Context, cardId string, name *string, cardFields *map[string]string) (*models.Card, error) {
	card := &models.Card{}
...
func (r *Repository) GetOneCard(ctx context.Context, cardId string) (*models.Card, error) {
	card := &models.Card{}
...
func (r *Repository) GetOneCardWithoutRelations(ctx context.Context, cardId string) (*models.Card, error) {
	card := &models.Card{}
...
func (r *Repository) DeleteOneCard(ctx context.Context, cardId string) error {
...
func (r *Repository) UpdateOrderForCard(ctx context.Context, cardId string, pipelineId string, oldOrder int, newOrder int) error {
	if newOrder <= 0 {
