...
func (r *Repository) AddDashboard(name string, userId string) (*models.Dashboard, error) {
...
func (r *Repository) GetOneDashboardInternal(dashboardId string) (*models.Dashboard, error) {
...
func (r *Repository) GetOneDashboard(dashboardId string) (*models.Dashboard, error) {
	var dashboard models.Dashboard
...
func (r *Repository) GetOneDashboardWithUserAccess(dashboardId string, userId string, accessType string) (*models.Dashboard, error) {
	var dashboard models.Dashboard
...
func (r *Repository) UpdateDashboardName(dashboardId string, name string) error {
...
func (r *Repository) DeleteDashboardById(dashboardId string) error {
...
func (d *Repository) UpdateAccessDashboard(dashboardId string, userId string, access string) error {
...
func (d *Repository) RemoveAccessDashboard(dashboardId string, userId string) error {
...
func (d *Repository) GetDashboardsByUser(userId string) ([]models.Dashboard, error) {
